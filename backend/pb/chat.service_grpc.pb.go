...
func (c *chatClient) Send(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Reply, error) {
	out := new(Reply)
	err := c.cc.Invoke(ctx, "/ding4.Chat/Send", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatClient) Broadcast(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Reply, error) {
	out := new(Reply)
	err := c.cc.Invoke(ctx, "/ding4.Chat/Broadcast", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedChatServer) Send(context.Context, *Request) (*Reply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Send not implemented")
}
func (UnimplementedChatServer) Broadcast(context.Context, *Request) (*Reply, error) {
...
func _Chat_Broadcast_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ding4.Chat/Broadcast",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServer).Broadcast(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Chat_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "protofile/services/chat.service.proto",
}
